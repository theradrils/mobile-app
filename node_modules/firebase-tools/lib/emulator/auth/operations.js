...
function parseClaims(idTokenOrJsonClaims) {
    ...
    if (!claims.sub) {
        throw new errors_1.BadRequestError('INVALID_IDP_RESPONSE : Invalid Idp Response: id_token missing required fields. ((Missing "sub" field. This field is required and must be a unique identifier.))');
    }
    return claims;
}
